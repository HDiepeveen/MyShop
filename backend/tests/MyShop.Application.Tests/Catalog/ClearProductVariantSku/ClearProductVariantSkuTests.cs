...
namespace MyShop.Application.Tests.Catalog.ClearProductVariantSku;

public sealed class ClearProductVariantSkuTests
{
    [Fact]
    ...
    [Fact]
    public async Task ExecuteAsync_ClearsSkuAndSavesWithReadToken()
    {
    ...
    [Fact]
    public async Task ExecuteAsync_WithoutSku_IsIdempotentWithoutSave()
    {
        var scenario = new Scenario(withSku: false);
    ...
    public async Task ExecuteAsync_WhenProductMissing_ReturnsFailureWithoutSave()
    {
        ...
        Assert.Equal(ClearProductVariantSkuFailure.ProductNotFound, result.Failure);
        Assert.Equal(0, scenario.Repository.SaveCalls);
    }
    ...
    public async Task ExecuteAsync_WhenVariantMissing_ReturnsFailureWithoutSave()
    {
        ...
        Assert.Equal(ClearProductVariantSkuFailure.VariantNotFound, result.Failure);
        Assert.Equal(0, scenario.Repository.SaveCalls);
    ...
    private sealed class Scenario
    {
        ...
        public ClearProductVariantSkuCommand Command { get; }
