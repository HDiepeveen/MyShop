...
{
    [Fact]
    public void MapAddProductTypeAttribute_NullBuilder_Throws() =>
        Assert.Throws<ArgumentNullException>(() => AddProductTypeAttributeEndpoint.MapAddProductTypeAttribute(null!));
