...
public sealed class SetVariantAttributeValueEndpointTests
{
    ...
    private static SetVariantAttributeValueRequest Request(AttributeDataType dataType, string json)
    {
        using var document = JsonDocument.Parse(json);
        return new SetVariantAttributeValueRequest(dataType, document.RootElement.Clone());
    }
